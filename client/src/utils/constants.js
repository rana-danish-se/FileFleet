...
// New access routes for file preview and download
export const GET_FILE_PREVIEW_ROUTE = (fileId) => `${FILES_ROUTE}/access/${fileId}/preview`;
export const GET_FILE_DOWNLOAD_ROUTE = (fileId) => `${FILES_ROUTE}/access/${fileId}/download`;
